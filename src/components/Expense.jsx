...
import AddExpense from "./ReusableComponents/AddExpense"
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-4 bg-[#f5f5f0] p-5">
            ...
            <div className="w-full lg:w-4/5 h-screen bg-[#ffaa00] p-4 lg:p-8 border rounded-2xl">
                <h1 className="text-2xl roboto-bold">Expense</h1>
             ...
             {/* Content and Delete Icon */}
                <div className="flex justify-between w-full">
                         <div className="flex flex-col">
                                <span className="ml-2 roboto-bold">shopping new computer</span>
